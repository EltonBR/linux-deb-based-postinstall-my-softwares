...
#tools
sudo apt install openssh-server wine-stable wireshark remmina remmina-plugin-vnc remmina-plugin-rdp aircrack-ng nmap 
 qemu gparted deluge google-chrome-stable aria2 pdfimages curl -y
